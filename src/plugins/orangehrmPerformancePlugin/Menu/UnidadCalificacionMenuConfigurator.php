...
class UnidadCalificacionMenuConfigurator implements MenuConfigurator
{
    ...
    {
        // Configura la pantalla para la búsqueda de UnidadCalificacion
        $this->getCurrentModuleAndScreen()->overrideScreen('searchUnidadCalificacion');
        return null;
    }
}
